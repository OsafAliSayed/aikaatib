...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-purple-950 flex items-center justify-center p-4" style={{ background: 'radial-gradient(circle at center, rgba(76, 29, 149, 0.5) 0%, rgba(0, 0, 0, 1) 100%)' }}>
